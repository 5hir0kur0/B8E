...
public interface Register {
    ...
    /**
     * @param target
     *     the {@code NumeralSystem} used to perform the conversion
     * @return
     *     a {@code String} representing the {@code Register}'s (unsigned) value in the numeral system specified by
     *     {@code target}
     */
     ...
     * @param numeralSystem
     *     the {@code NumeralSystem} used for the conversion
     * @param newValue
     *     {@code String} that holds the value; must not be {@code null} or empty
     * @return
     *     {@code boolean} indicating whether the operation was successful
     */
